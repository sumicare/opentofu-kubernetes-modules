...
var (
	...
	kindClusterName = "descheduler-test"
)

// TestDeschedulerSuite bootstraps descheduler terraform module test, with Terratest.
func TestDeschedulerSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Descheduler suite test")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy descheduler
