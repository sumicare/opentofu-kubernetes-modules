...
locals {
  ...
  pvc_autoresizer_version = "{{index .Versions "storage-pvc-autoresizer"}}"
}
...
| pvc_autoresizer_version | PVC Autoresizer version to deploy  | string | `"{{index .Versions "storage-pvc-autoresizer"}}"` | no         |
