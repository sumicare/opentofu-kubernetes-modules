      ...
      spec {
        ...
        container {
          ...
          args = [
            ...
            "--enable-webhook-patching=false",
            "--cert-dir=/certs",
            "--enable-cert-rotation=false",
            "--cert-secret-name=${local.app_name}-certs",
            "--operator-service-name=${local.app_name}-operator",
            "--metrics-server-service-name=${local.app_name}-operator-metrics-apiserver",
            "--webhooks-service-name=${local.app_name}-admission-webhooks",
            "--k8s-cluster-name=${var.cluster_name}",
            "--k8s-cluster-domain=${var.cluster_domain}",
            "--enable-prometheus-metrics=${var.enable_prometheus_metrics}"
          ]
        ...
        service_account_name = "${local.app_name}-operator"
