...
var (
	...
	kindClusterName = "kind-cost-exporter-test"
)

// TestCostExporterSuite bootstraps cost-exporter terraform module test, with Terratest.
func TestCostExporterSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "CostExporter Chart test suite")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy cost-exporter
