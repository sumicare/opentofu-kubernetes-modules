...
helm template project-zot/zot --namespace zot --values values.yaml --include-crds --set crds.enabled=true 2>&1 |
  awk '
    BEGIN {
        skip_resource = 0
        resource_content = ""
...
helm template project-zot/zot --namespace zot --values values.yaml --include-crds --set crds.enabled=true |
  awk '
        BEGIN {
            include_resource = 0
            resource_content = ""
