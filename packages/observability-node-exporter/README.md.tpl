...
locals {
  ...
  node_exporter_version = "{{index .Versions "observability-node-exporter"}}"
}
...
| node_exporter_version | Node Exporter version to deploy   | string | `"{{index .Versions "observability-node-exporter"}}"` | no         |
