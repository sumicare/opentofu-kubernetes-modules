...
var (
	...
	kindClusterName = "goldilocks-test"
)

// TestGoldilocksSuite bootstraps goldilocks terraform module test, with Terratest.
func TestGoldilocksSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Goldilocks suite test")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy goldilocks
