...
var (
	...
	kindClusterName = "rollout-operator-test"
)

// TestRolloutOperatorSuite bootstraps rollout-operator terraform module test, with Terratest.
func TestRolloutOperatorSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "RolloutOperator suite test")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy rollout-operator
