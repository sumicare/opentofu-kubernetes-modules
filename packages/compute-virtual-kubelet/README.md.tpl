...
locals {
  ...
  virtual_kubelet_version = "{{index .Versions "compute-virtual-kubelet"}}"
}
...
| virtual_kubelet_version | Virtual Kubelet version to deploy  | string | `"{{index .Versions "compute-virtual-kubelet"}}"` | no         |
