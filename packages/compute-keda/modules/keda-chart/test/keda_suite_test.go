...
var (
	...
	kindClusterName = "keda-test"
)

// TestKedaSuite bootstraps keda terraform module test, with Terratest.
func TestKedaSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Keda suite test")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy keda
