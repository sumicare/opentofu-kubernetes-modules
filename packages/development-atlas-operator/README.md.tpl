...
locals {
  ...
  atlas_operator_version = "{{index .Versions "development-atlas-operator"}}"
}
...
| atlas_operator_version | Atlas Operator version to deploy   | string | `"{{index .Versions "development-atlas-operator"}}"` | no         |
