...
var (
	...
	kindClusterName = "kamaji-test"
)

// TestKamajiSuite bootstraps kamaji terraform module test, with Terratest.
func TestKamajiSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Kamaji suite test")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy kamaji
