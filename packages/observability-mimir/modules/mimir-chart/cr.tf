resource "kubernetes_manifest" "grafanaagent_mimir_release_name_mimir_meta_monitoring" {
  manifest = {
...
resource "kubernetes_manifest" "logsinstance_mimir_release_name_mimir_meta_monitoring" {
  manifest = {
    "apiVersion" = "monitoring.grafana.com/v1alpha1"
    "kind"       = "LogsInstance"
    "metadata" = {
...
resource "kubernetes_manifest" "metricsinstance_mimir_release_name_mimir_meta_monitoring" {
  manifest = {
    "apiVersion" = "monitoring.grafana.com/v1alpha1"
      ...
      "remoteWrite" = [
        {
          ...
          "url" = "http://release-name-mimir-gateway.mimir.svc:80/api/v1/push"
        },
      ]
...
resource "kubernetes_manifest" "mutatingwebhookconfiguration_prepare_downscale_mimir" {
  manifest = {
...
resource "kubernetes_manifest" "podlogs_mimir_release_name_mimir_meta_monitoring" {
  manifest = {
    "apiVersion" = "monitoring.grafana.com/v1alpha1"
    "kind"       = "PodLogs"
    "metadata" = {
...
resource "kubernetes_manifest" "prometheusrule_mimir_release_name_mimir_alerts" {
  manifest = {
    ...
    "metadata" = {
      ...
      "name"      = "release-name-mimir-alerts"
      "namespace" = "mimir"
    }
    "spec" = {
      "groups" = [
        {
          ...
          "rules" = [
            ...
            {
              "alert" = "MimirServerInvalidClusterValidationLabelRequests"
              "annotations" = {
            ...
            {
              "alert" = "MimirHighGRPCConcurrentStreamsPerConnection"
              "annotations" = {
                "message"     = <<-EOT
                ...
                EOT
                "runbook_url" = "https://grafana.com/docs/mimir/latest/operators-guide/mimir-runbooks/#mimirhighgrpcconcurrentstreamsperconnection"
              }
              "expr" = <<-EOT
...
resource "kubernetes_manifest" "prometheusrule_mimir_release_name_mimir_prometheus_rule" {
  manifest = {
    "apiVersion" = "monitoring.coreos.com/v1"
    "kind"       = "PrometheusRule"
    "metadata" = {
      ...
      "name"      = "release-name-mimir-prometheus-rule"
      "namespace" = "mimir"
    }
    "spec" = {
      "groups" = []
...
resource "kubernetes_manifest" "prometheusrule_mimir_release_name_mimir_rules" {
  manifest = {
    "apiVersion" = "monitoring.coreos.com/v1"
    "kind"       = "PrometheusRule"
    "metadata" = {
...
resource "kubernetes_manifest" "scaledobject_mimir_release_name_mimir_distributor" {
  manifest = {
      ...
      "triggers" = [
        {
          ...
          "metadata" = {
            ...
            "query"            = "max_over_time(sum(sum by (pod) (rate(container_cpu_usage_seconds_total{container=\"distributor\",namespace=\"mimir\",}[5m])) and max by (pod) (up{container=\"distributor\",namespace=\"mimir\",}) > 0)[15m:]) * 1000"
            "serverAddress"    = "prometheus.monitoring.svc:8080"
            "threshold"        = "100"
            "unsafeSsl"        = "false"
          }
          "type" = "prometheus"
        },
        {
          ...
          "metadata" = {
            "authModes"        = ""
            "ignoreNullValues" = "true"
            "query"            = "max_over_time(sum((sum by (pod) (container_memory_working_set_bytes{container=\"distributor\",namespace=\"mimir\",}) and max by (pod) (up{container=\"distributor\",namespace=\"mimir\",}) > 0) or vector(0))[15m:]) + sum(sum by (pod) (max_over_time(kube_pod_container_resource_requests{container=\"distributor\",namespace=\"mimir\", resource=\"memory\",}[15m])) and max by (pod) (changes(kube_pod_container_status_restarts_total{container=\"distributor\",namespace=\"mimir\",}[15m]) > 0) and max by (pod) (kube_pod_container_status_last_terminated_reason{container=\"distributor\",namespace=\"mimir\", reason=\"OOMKilled\",}) or vector(0))"
            "serverAddress"    = "prometheus.monitoring.svc:8080"
            "threshold"        = "536870912"
            "unsafeSsl"        = "false"
          }
...
resource "kubernetes_manifest" "scaledobject_mimir_release_name_mimir_querier" {
  manifest = {
    "apiVersion" = "keda.sh/v1alpha1"
    "kind"       = "ScaledObject"
    "metadata" = {
      ...
      "triggers" = [
        {
          ...
          "metadata" = {
            "authModes"        = ""
            "ignoreNullValues" = "true"
            "query"            = "sum(max_over_time(cortex_query_scheduler_inflight_requests{container=\"query-scheduler\",namespace=\"mimir\",quantile=\"0.5\",}[1m]))"
            "serverAddress"    = "prometheus.monitoring.svc:8080"
            "threshold"        = "12"
            "unsafeSsl"        = "false"
          }
        ...
        },
        {
          ...
          "metadata" = {
            "authModes"        = ""
            "ignoreNullValues" = "true"
            "query"            = "sum(rate(cortex_querier_request_duration_seconds_sum{container=\"querier\",namespace=\"mimir\",}[1m]))"
            "serverAddress"    = "prometheus.monitoring.svc:8080"
            "threshold"        = "12"
            "unsafeSsl"        = "false"
          }
...
resource "kubernetes_manifest" "scaledobject_mimir_release_name_mimir_query_frontend" {
  manifest = {
    "apiVersion" = "keda.sh/v1alpha1"
    "kind"       = "ScaledObject"
    "metadata" = {
      ...
      "triggers" = [
        {
          ...
          "metadata" = {
            "authModes"        = ""
            "ignoreNullValues" = "true"
            "query"            = "max_over_time(sum(sum by (pod) (rate(container_cpu_usage_seconds_total{container=\"query-frontend\",namespace=\"mimir\",}[5m])) and max by (pod) (up{container=\"query-frontend\",namespace=\"mimir\",}) > 0)[15m:]) * 1000"
            "serverAddress"    = "prometheus.monitoring.svc:8080"
            "threshold"        = "75"
            "unsafeSsl"        = "false"
          }
        ...
        },
        {
          ...
          "metadata" = {
            "authModes"        = ""
            "ignoreNullValues" = "true"
            "query"            = "max_over_time(sum((sum by (pod) (container_memory_working_set_bytes{container=\"query-frontend\",namespace=\"mimir\",}) and max by (pod) (up{container=\"query-frontend\",namespace=\"mimir\",}) > 0) or vector(0))[15m:]) + sum(sum by (pod) (max_over_time(kube_pod_container_resource_requests{container=\"query-frontend\",namespace=\"mimir\", resource=\"memory\",}[15m])) and max by (pod) (changes(kube_pod_container_status_restarts_total{container=\"query-frontend\",namespace=\"mimir\",}[15m]) > 0) and max by (pod) (kube_pod_container_status_last_terminated_reason{container=\"query-frontend\",namespace=\"mimir\", reason=\"OOMKilled\",}) or vector(0))"
            "serverAddress"    = "prometheus.monitoring.svc:8080"
            "threshold"        = "134217728"
            "unsafeSsl"        = "false"
          }
...
resource "kubernetes_manifest" "scaledobject_mimir_release_name_mimir_ruler" {
  manifest = {
    "apiVersion" = "keda.sh/v1alpha1"
    "kind"       = "ScaledObject"
    "metadata" = {
      ...
      "triggers" = [
        {
          ...
          "metadata" = {
            "authModes"        = ""
            "ignoreNullValues" = "true"
            "query"            = "max_over_time(sum(sum by (pod) (rate(container_cpu_usage_seconds_total{container=\"ruler\",namespace=\"mimir\",}[5m])) and max by (pod) (up{container=\"ruler\",namespace=\"mimir\",}) > 0)[15m:]) * 1000"
            "serverAddress"    = "prometheus.monitoring.svc:8080"
            "threshold"        = "100"
            "unsafeSsl"        = "false"
          }
        ...
        },
        {
          ...
          "metadata" = {
            "authModes"        = ""
            "ignoreNullValues" = "true"
            "query"            = "max_over_time(sum((sum by (pod) (container_memory_working_set_bytes{container=\"ruler\",namespace=\"mimir\",}) and max by (pod) (up{container=\"ruler\",namespace=\"mimir\",}) > 0) or vector(0))[15m:]) + sum(sum by (pod) (max_over_time(kube_pod_container_resource_requests{container=\"ruler\",namespace=\"mimir\", resource=\"memory\",}[15m])) and max by (pod) (changes(kube_pod_container_status_restarts_total{container=\"ruler\",namespace=\"mimir\",}[15m]) > 0) and max by (pod) (kube_pod_container_status_last_terminated_reason{container=\"ruler\",namespace=\"mimir\", reason=\"OOMKilled\",}) or vector(0))"
            "serverAddress"    = "prometheus.monitoring.svc:8080"
            "threshold"        = "134217728"
            "unsafeSsl"        = "false"
          }
...
resource "kubernetes_manifest" "triggerauthentication_mimir_keda_triggger_auth" {
  manifest = {
    "apiVersion" = "keda.sh/v1alpha1"
...
resource "kubernetes_manifest" "validatingwebhookconfiguration_no_downscale_mimir" {
  manifest = {
    "apiVersion" = "admissionregistration.k8s.io/v1"
...
resource "kubernetes_manifest" "validatingwebhookconfiguration_pod_eviction_mimir" {
  manifest = {
    "apiVersion" = "admissionregistration.k8s.io/v1"
    "kind"       = "ValidatingWebhookConfiguration"
    "metadata" = {
...
resource "kubernetes_manifest" "validatingwebhookconfiguration_zpdb_validation_mimir" {
  manifest = {
    "apiVersion" = "admissionregistration.k8s.io/v1"
    "kind"       = "ValidatingWebhookConfiguration"
    "metadata" = {
