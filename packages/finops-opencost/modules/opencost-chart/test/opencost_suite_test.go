...
var (
	...
	kindClusterName = "kind-open-cost-test"
)

// TestOpenCostSuite bootstraps open-cost terraform module test, with Terratest.
func TestOpenCostSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "OpenCost Chart test suite")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy open-cost
