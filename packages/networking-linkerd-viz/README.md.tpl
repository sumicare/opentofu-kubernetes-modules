...
locals {
  ...
  linkerd_viz_version = "{{index .Versions "networking-linkerd-viz"}}"
}
...
| linkerd_viz_version | Linkerd Viz version to deploy    | string | `"{{index .Versions "networking-linkerd-viz"}}"` | no         |
