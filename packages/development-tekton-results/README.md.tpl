...
locals {
  ...
  tekton_results_version = "{{index .Versions "development-tekton-results"}}"
}
...
| tekton_results_version | Tekton Results version to deploy   | string | `"{{index .Versions "development-tekton-results"}}"` | no         |
