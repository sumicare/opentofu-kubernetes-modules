...
locals {
  ...
  bank_vaults_operator_version = "{{index .Versions "security-bank-vaults-operator"}}"
}
...
| bank_vaults_operator_version | Bank-Vaults Operator version to deploy  | string | `"{{index .Versions "security-bank-vaults-operator"}}"` | no         |
