...
resource "kubernetes_pod_disruption_budget" "release_name_argo_events_controller_manager" {
  metadata {
...
resource "kubernetes_pod_disruption_budget" "release_name_argo_events_events_webhook" {
  metadata {
