...
locals {
  ...
  data_fusion_ballista_version = "{{index .Versions "mlops-data-fusion-ballista"}}"
}
...
| data_fusion_ballista_version | DataFusion Ballista version to deploy   | string | `"{{index .Versions "mlops-data-fusion-ballista"}}"` | no         |
