...
var (
	...
	kindClusterName = "vpa-test"
)

// TestVpaSuite bootstraps vpa terraform module test, with Terratest.
func TestVpaSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Vpa suite test")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy vpa
