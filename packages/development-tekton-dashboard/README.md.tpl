...
locals {
  ...
  tekton_dashboard_version = "{{index .Versions "development-tekton-dashboard"}}"
}
...
| tekton_dashboard_version | Tekton Dashboard version to deploy   | string | `"{{index .Versions "development-tekton-dashboard"}}"` | no         |
