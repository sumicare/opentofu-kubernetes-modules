...
var (
	...
	kindClusterName = "kind-zot-test"
)

// TestZotSuite bootstraps zot terraform module test, with Terratest.
func TestZotSuite(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Zot Chart test suite")
}
...
var _ = BeforeSuite(func() {
	...
	// Apply OpenTofu configuration to deploy zot
